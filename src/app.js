let App = {
    init() {
        ...
        // Add search tips for employers link
        if ($('#editListingForm [data-field="custom_field_HowRemote_2028"]').length) {
            $('#editListingForm [data-field="custom_field_HowRemote_2028"]').append('<a href="/blog/employers-guide-to-remotejobs/" id="search-tips" target="_blank">Read our job posting tips</a>');
        }
